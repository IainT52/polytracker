...
CREATE TABLE `__new_markets` (
	...
	`created_at` integer DEFAULT '"2026-03-10T02:32:10.968Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-10T02:32:10.968Z"' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_markets`("id", "condition_id", "question", "slug", "description", "outcomes", "clob_token_ids", "volume", "end_date", "icon", "resolved", "alpha_signal_fired", "created_at", "updated_at") SELECT "id", "condition_id", "question", "slug", "description", "outcomes", "clob_token_ids", "volume", "end_date", "icon", "resolved", "alpha_signal_fired", "created_at", "updated_at" FROM `markets`;--> statement-breakpoint
...
CREATE TABLE `__new_trades` (
	...
	`timestamp` integer DEFAULT '"2026-03-10T02:32:10.968Z"' NOT NULL,
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-03-10T02:32:10.967Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-10T02:32:10.967Z"' NOT NULL
);
--> statement-breakpoint
