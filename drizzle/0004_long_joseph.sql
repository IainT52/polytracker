...
CREATE TABLE `__new_markets` (
	...
	`created_at` integer DEFAULT '"2026-03-10T02:43:16.287Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-10T02:43:16.287Z"' NOT NULL
);
...
CREATE TABLE `__new_trades` (
	...
	`timestamp` integer DEFAULT '"2026-03-10T02:43:16.287Z"' NOT NULL,
