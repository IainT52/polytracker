...
CREATE TABLE `__new_markets` (
	...
	`created_at` integer DEFAULT '"2026-03-10T02:36:40.071Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-10T02:36:40.072Z"' NOT NULL
);
...
CREATE TABLE `__new_trades` (
	...
	`timestamp` integer DEFAULT '"2026-03-10T02:36:40.072Z"' NOT NULL,
...
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-03-10T02:36:40.071Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-10T02:36:40.071Z"' NOT NULL
);
--> statement-breakpoint
