...
CREATE TABLE `__new_markets` (
	...
	`created_at` integer DEFAULT '"2026-03-07T00:33:14.302Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-07T00:33:14.302Z"' NOT NULL
);
--> statement-breakpoint
INSERT INTO `__new_markets`("id", "condition_id", "question", "description", "outcomes", "clob_token_ids", "volume", "end_date", "icon", "resolved", "created_at", "updated_at") SELECT "id", "condition_id", "question", "description", "outcomes", "clob_token_ids", "volume", "end_date", "icon", "resolved", "created_at", "updated_at" FROM `markets`;--> statement-breakpoint
...
CREATE TABLE `__new_paper_positions` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_paper_positions`("id", "user_id", "market_id", "outcome_index", "buy_price", "shares", "total_cost", "resolved_price", "realized_pnl", "timestamp", "status") SELECT "id", "user_id", "market_id", "outcome_index", "buy_price", "shares", "total_cost", "resolved_price", "realized_pnl", "timestamp", "status" FROM `paper_positions`;--> statement-breakpoint
DROP TABLE `paper_positions`;--> statement-breakpoint
ALTER TABLE `__new_paper_positions` RENAME TO `paper_positions`;--> statement-breakpoint
CREATE TABLE `__new_trades` (
	...
	`price` real NOT NULL,
	`shares` real NOT NULL,
	`timestamp` integer DEFAULT '"2026-03-07T00:33:14.302Z"' NOT NULL,
...
CREATE TABLE `__new_user_positions` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`user_id` integer NOT NULL,
	`market_id` integer NOT NULL,
	`outcome_index` integer NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_user_positions`("id", "user_id", "market_id", "outcome_index", "buy_price", "shares", "total_cost", "timestamp", "status", "order_id", "transaction_hash") SELECT "id", "user_id", "market_id", "outcome_index", "buy_price", "shares", "total_cost", "timestamp", "status", "order_id", "transaction_hash" FROM `user_positions`;--> statement-breakpoint
DROP TABLE `user_positions`;--> statement-breakpoint
ALTER TABLE `__new_user_positions` RENAME TO `user_positions`;--> statement-breakpoint
CREATE TABLE `__new_users` (
	...
	`created_at` integer DEFAULT '"2026-03-07T00:33:14.301Z"' NOT NULL,
	`updated_at` integer DEFAULT '"2026-03-07T00:33:14.301Z"' NOT NULL
);
--> statement-breakpoint
