import { validateTradeSafety, OrderBook } from './services/safetyFilters';
...
function runSafetyTests() {
  ...
  const res1 = validateTradeSafety(
    mockOrderBook,
    alphaPrice,
    50,   // $50 Bet
    300,  // Max Spread 3%
  ...
  if (res1.passed) console.log(`Execution Price: $${res1.executionPrice?.toFixed(4)}, Shares: ${res1.expectedShares?.toFixed(2)}`);
  ...
  const res2 = validateTradeSafety(
    mockOrderBook,
    alphaPrice,
    150,  // $150 Bet
    300,  // Max Spread 3%
  ...
  const res3 = validateTradeSafety(
    mockOrderBook,
    alphaPrice,
    10,   // $10 Bet
  ...
  const res4 = validateTradeSafety(
    mockOrderBook,
    alphaPrice,
    10,   // $10 Bet
    300,  // Max Spread 3%
